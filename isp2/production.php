...
<!-- Recieve products -->
	<div class="col-md-12 col-sm-12">
		<div class="panel panel-default">
			...
			<h4>Receive product : <a href="Products.php" class="btn btn-default btn-sm "> Get all History </a><?php if (isset($msg)) {echo "$msg";} ?></h4>
				...
				<div class="col-md-12">
					...
					<input type="hidden" name="recipient" value="">			
				      ...
				      <div class="form-group">
				        ...
				        <input type="text" class="form-control" name="provider" id="provider" placeholder="provider" required="">
				      </div>
				      <div class="form-group">
...
<div class="col-md-12 col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading">
			<h4>Send Product : <a href="products.php" class="btn btn-default btn-sm "> Get all History </a><?php if (isset($msg)) {echo "$msg";} ?></h4>
			</div>
			<div class="panel-body">
				<div class="col-md-12">
					<form class="form-inline"  action="products.php" method="POST">
